...
public class CopperPickaxe extends MiningToolItem {
    public static String blocksMined = "blocksMined";
    public static Tag<Block> EffectiveBlocks;
    public CopperPickaxe(float attackDamage, float attackSpeed, ToolMaterial material, Tag<Block> effectiveBlocks, Settings settings) {
